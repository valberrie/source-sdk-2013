...
// vv - don't know if this is necessary yet, the ai may just use
// 		weapon_crowbar and weapon_stunstick
// 
...
// 		Vector(-16,-16,-16), Vector(36,36,36), GetDamageForActivity( nHitActivity ), DMG_CLUB, 0.75 );
